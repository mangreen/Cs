...
III_INT setIdrResultNode(IndoorAStar* idras, Node* stay){
	...
	idras->result.resultNode = (III_RESULTNODE*)III_malloc(sizeof(III_RESULTNODE)*(idras->result.numNode));   // 弄個新空間;
...
III_INT setIdrResult(IndoorAStar* idras, Node* stay, III_INT flag){
	...
	idras->resultIdr.resultEdge = (III_PDRTEDGE*)III_malloc(sizeof(III_PDRTEDGE)*(idras->resultIdr.numEdge));   // 弄個新空間;
	idras->result.resultNode = (III_RESULTNODE*)III_malloc(sizeof(III_RESULTNODE)*(idras->result.numNode));   // 弄個新空間;//wally modify
...
III_INT finishAStar(IndoorAStar *idras){
	...
	idras->clList.list = III_NULL;
	idras->nodeCache = III_NULL;
