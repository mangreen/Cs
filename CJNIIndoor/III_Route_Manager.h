...
struct MdbStreet
{
	III_UINT m_sid;          //���q�y����ID
	III_UCHAR m_countryID;   //��a���O
	III_CHAR m_frc;          //�D������
	III_USHORT m_oneWay;     //�樮��V (0-3)
	III_USHORT m_kph;        //�t��
	III_CHAR m_fow;          //�O�_�����t����
	III_CHAR m_pName[70];    //�D���W��
	III_CHAR m_rNumName[10]; //�D���f���W��
	III_INT m_rid;           //�D���y����ID
	III_USHORT m_ptNum;
	III_INT *m_ptsX;
	III_INT *m_ptsY;
	III_INT *m_X1;
